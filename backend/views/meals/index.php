        ...
        <?php foreach ($mealCount as $name => $count) { ?>
            ...
            <div class="">
                ...
                <div class="small-box bg-success">
                    ...
                    <?= Html::a('More Info <i class="fas fa-arrow-circle-right"></i>', ['meals/category', 'categoryid' => $id = Category::getCategoriaIDByName($name), 'categoryname' => $name], ['data-method' => 'post', 'class' => 'small-box-footer']) ?>
